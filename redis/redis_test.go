...
func Init() {
	...
	_ = os.Setenv("KTenantName", "xxxxx")
	_ = os.Setenv("KNamespace", "xxxxx")
	_ = os.Setenv("KSvcID", "xxxxx")
	_ = os.Setenv("KClientID", "xxxxx")
	_ = os.Setenv("KClientSecret", "xxxxx")
	_ = os.Setenv("KOpenApiDomain", "xxxxx")
	_ = os.Setenv("KFaaSInfraDomain", "xxxxx")
	//_ = os.Setenv("KFaaSInfraDomain", "xxxxx")
	//_ = os.Setenv("KFaaSInfraDomain", "xxxxx")
}
...
func Test_AB_Expire(t *testing.T) {
	cmd := redisCli.Expire(ctx, "TestKey", 60*time.Second)
	v, e := cmd.Result()
	fmt.Printf("Res: %v, Err: %v\n", v, e)
...
func Test_AB_ExpireAt(t *testing.T) {
	cmd := redisCli.ExpireAt(ctx, "TestKey", time.Now().Add(2*60*time.Second))
	v, e := cmd.Result()
	fmt.Printf("Res: %v, Err: %v\n", v, e)
	assert.Equal(t, true, v)
	assert.Empty(t, e)
...
func Test_AB_PExpire(t *testing.T) {
	cmd := redisCli.PExpire(ctx, "TestKey", 60*time.Second)
	v, e := cmd.Result()
	fmt.Printf("Res: %v, Err: %v\n", v, e)
	assert.Equal(t, true, v)
	assert.Empty(t, e)
...
func Test_AB_PExpireAt(t *testing.T) {
	cmd := redisCli.PExpireAt(ctx, "TestKey", time.Now().Add(60*time.Second))
	v, e := cmd.Result()
	fmt.Printf("Res: %v, Err: %v\n", v, e)
	assert.Equal(t, true, v)
	assert.Empty(t, e)
...
func Test_AH_SetNX(t *testing.T) {
	cmd := redisCli.SetNX(ctx, "TestKey", "Value", time.Second*10)
	v, e := cmd.Result()
	fmt.Printf("Res: %v, Err: %v\n", v, e)
	assert.Equal(t, true, v)
	assert.Empty(t, e)
	//fmt.Println(redisCli.Del(ctx, "TestKey").Result())
	//cmd := redisCli.SetNX(ctx, "TestKey", "Value", time.Second*10)
	//v, e := cmd.Result()
	//fmt.Printf("Res: %v, Err: %v\n", v, e)
	//assert.Equal(t, true, v)
	//assert.Empty(t, e)
	//
	//fmt.Println(redisCli.Get(ctx, "TestKey").Result())
	//fmt.Println(redisCli.TTL(ctx, "TestKey").Result())
	//
	//cmd = redisCli.SetNX(ctx, "TestKey", "Value", 0)
	//v, e = cmd.Result()
	//fmt.Printf("Res: %v, Err: %v\n", v, e)
	...
	//
	//fmt.Println(redisCli.Del(ctx, "TestKey").Result())
	//cmd = redisCli.SetNX(ctx, "TestKey", "Value", time.Millisecond*800)
	//v, e = cmd.Result()
	//fmt.Printf("Res: %v, Err: %v\n", v, e)
	//assert.Equal(t, true, v)
	//assert.Empty(t, e)
	//
	//fmt.Println(redisCli.PTTL(ctx, "TestKey").Result())
	//fmt.Println(redisCli.Get(ctx, "TestKey").Result())
}
...
func Test_BA_MSet(t *testing.T) {
	...
	cmd = redisCli.MSet(ctx, "key3", "value3", "key4", "value4")
	v, e = cmd.Result()
	fmt.Printf("Res: %v, Err: %v\n", v, e)
	assert.Equal(t, "OK", v)
	assert.Empty(t, e)
...
func Test_BB_MGet(t *testing.T) {
	cmd := redisCli.MGet(ctx, "key1", "key2", "key3", "key4")
	v, e := cmd.Result()
	fmt.Printf("Res: %v, Err: %v\n", v, e)
	assert.Equal(t, true, len(v) == 4)
	assert.Empty(t, e)
}
...
func Test_CB_IncrByFloat(t *testing.T) {
	cmd := redisCli.IncrByFloat(ctx, "FloatKey", 2.1)
	v, e := cmd.Result()
	fmt.Printf("Res: %v, Err: %v\n", v, e)
	assert.Equal(t, true, v > 0)
	assert.Empty(t, e)
...
func Test_EB_HMSet(t *testing.T) {
	cmd := redisCli.HMSet(ctx, "HashKey", map[string]interface{}{"field1": "value1", "field2": "value2"})
	v, e := cmd.Result()
	fmt.Printf("Res: %v, Err: %v\n", v, e)
	assert.Equal(t, true, len(v) > 0)
	assert.Empty(t, e)

	cmd = redisCli.HMSet(ctx, "HashKey", "field3", 1, "field4", "value4")
	redisCli.Expire(ctx, "HashKey", time.Minute)
	v, e = cmd.Result()
	fmt.Printf("Res: %v, Err: %v\n", v, e)
	assert.Equal(t, true, len(v) > 0)
	assert.Empty(t, e)
...
func Test_EB_HMGet(t *testing.T) {
	cmd := redisCli.HMGet(ctx, "HashKey", "field1", "field2", "field3", "field4")
	v, e := cmd.Result()
	fmt.Printf("Res: %v, Err: %v\n", v, e)
	assert.Equal(t, true, len(v) == 4)
	assert.Empty(t, e)
...
func Test_EC_HIncrByFloat(t *testing.T) {
	cmd := redisCli.HIncrByFloat(ctx, "HashKey", "FloatKey", 2.1)
	v, e := cmd.Result()
	fmt.Printf("Res: %v, Err: %v\n", v, e)
	assert.Equal(t, true, v > 0)
	assert.Empty(t, e)
...
func Test_AAA_Del(t *testing.T) {
	redisCli.Del(ctx, "IntKey", "FloatKey", "NotExistKey", "ListKey", "{Set}Key", "{Set}Key_4", "{Set}Key_5", "{ZSet}Key", "{ZSet}Key_4", "{ZSet}Key_6", "{PF}Key", "{PF}Key_1")
}
